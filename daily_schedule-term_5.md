...
* Tuesday, Apr. 16 &mdash; Study Q15 &mdash; [Problem Set 18](./assignments/AssignmentFor2024-04-16.nb.pdf) &mdash; Some Q15 topics: (1) Nuclear stability (and in particular, why we plot binding energy per nucleon rather than just binding energy) (2) High-energy neutrons (mostly captured) vs. thermal neutrons (the ones that are likely to cause new fissions) in a reactor &mdash; Choose the remaining special topics (you will have homeworks on the special topics but not be tested on them) &mdash; We [got started on MRI](./resources/MagneticResonanceI.nb.pdf) by reviewing the behavior of a magnetic moment in the large magnetic field of an MRI machine (we did not get to the small oscillating field which is responsible for magnetic resonance)
* Friday, Apr. 19 &mdash; Presentation by Miles (maybe someone wants to join him!?): How are atoms or electrons or ions counted so as to make 1 mole (abbreviated mol), *in practice*; and in particular, how is the gram which is now *defined* as 1/12 of the mass of an Avogadro's number (602,214,076,000,000,000,000,000) of Carbon-12 atoms counted, *in practice* &mdash; Continue MRI &mdash; [Problem Set 19 - FORTHCOMING](./assignments/AssignmentFor2024-04-19.nb.pdf)
